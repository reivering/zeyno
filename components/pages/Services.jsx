  ...
  return (
    <div id='services' className='w-full h-screen font-inter px-20 bg-background '>
        ...
        <div className='flex flex-row justify-between '>
            ...
            <div className='flex  ml-[20vw] items-end gap-3 mr-16'>
                <h1 className='p-4 bg-black rounded-full text-[28px] font-light px-6 text-base'>know more</h1>
        ...
        <div className='flex justify-center p-4  mt-[3vh] w-full h-[70%] gap-16'>
            {/* Design Card */}
            <div className='w-[500px] h-[55vh] rounded-[7vh] bg-base flex flex-col p-10'>
